...
```{r}
ggsave(file.path(file = paste0(own_path, "/group_04_project/TCGA_data/mrna_boxplot.png")), plot = mRNA_box, width = 14, height = 8, unit = "in")

ggsave(file.path(file = paste0(own_path, "/group_04_project/TCGA_data/mrna_expression.png")), plot = mRNA_expression, width = 14, height = 8, unit = "in")

ggsave(file.path(file = paste0(own_path, "/group_04_project/TCGA_data/mrna_vol.png")), plot = mrna_vol, width = 14, height = 8, unit = "in")
```
