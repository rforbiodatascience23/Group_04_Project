...
```{r}
ggsave(file.path(file = paste0(own_path, "/group_04_project/TCGA_data/mirna_boxplot.png")), plot = miRNA_box, width = 14, height = 8, unit = "in")

ggsave(file.path(file = paste0(own_path, "/group_04_project/TCGA_data/mirna_expression.png")), plot = miRNA_expression, width = 14, height = 8, unit = "in")

ggsave(file.path(file = paste0(own_path, "/group_04_project/TCGA_data/mirna_vol.png")), plot = mirna_vol, width = 14, height = 8, unit = "in")
```
