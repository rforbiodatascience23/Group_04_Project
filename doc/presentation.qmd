...
![](images/Introduction%20-%20Article.png)
...
|                                                      |                                               |
|------------------------------------------------------|-----------------------------------------------|
| ![](images/gse_gender_distribution.png){width="257"} | ![](images/cancer_frequency.png){width="266"} |
...
|                                     |                               |
|-------------------------------------|-------------------------------|
| ![](images/gender_distribution.png) | ![](images/cancer_stages.png) |
...
#| echo: false
own_path <- "/Users/mathildebechgaard"
miRNA_top_genes_stat <- readRDS(paste0(own_path, "/group_04_project/data/miRNA_top_genes_stat.RDS")) |> tibble()
...
miRNA_aug <- readRDS(paste0(own_path, "/group_04_project/data/miRNA_aug.RDS"))
miRNA_aug
```
...
|-----------------------------|------------------------------|------------------------------|
| ![](images/mrna_vol-01.png) | ![](images/mirna_vol-02.png) | ![](images/gse_vol_plot.png) |
