...
#| echo: false
own_path <- "/Users/mathildebechgaard"
miRNA_top_genes_stat <- readRDS(paste0(own_path, "/group_04_project/TCGA_data/miRNA_top_genes_stat.RDS")) |> tibble()
...
miRNA_aug <- readRDS(paste0(own_path, "/group_04_project/TCGA_data/miRNA_aug.RDS"))
miRNA_aug
```
