...
```{r}
ggsave(file.path("../results/images/", "occurences_gender.png"), gse_plot1, width = 10, height = 6, units = "in")
ggsave(file.path("../results/images/", "cancer_frequency.png"), gse_plot2, width = 10, height = 6, units = "in")
ggsave(file.path("../results/images/", "gse_gender_distribution.png"), gse_plot3, width = 10, height = 6, units = "in")
```
