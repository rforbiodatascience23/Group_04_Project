...
```{r setup}
own_path <- "/Users/kseniakirdey/Desktop/DTU/R_for_bio_data_science/lab_10_Project/group_04_project/"
...
```{r}
exp_gse_results <- readRDS(paste0(own_path, "data/gse_expressed_data.RDs"))
mirna_exp <- readRDS(paste0(own_path, "data/gse_all_data.RDs"))
```
...
```{r}
saveRDS(gse_results, file = paste0(own_path, "Results/gse_results.rds"))
saveRDS(high_expressed_genes, file = paste0(own_path, "Results/gse_expressed_genes.rds"))
saveRDS(top_20_genes, file = paste0(own_path, "Results/gse_top_20.rds"))
saveRDS(top_20_genes, file = paste0(own_path, "Results/gse_top_20.rds"))
ggsave(file = paste0(own_path, "Results/images/gse_vol_plot.pdf"), plot = gse_vol, width = 14, height = 8.4, units = "in")
```
