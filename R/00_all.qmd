...
saveRDS(gpl, file = paste0(path, "/GSE_data/gse_chosen_meta_data.RDs"))

saveRDS(mirna_exp, file = paste0(path, "/GSE_data/gse_all_data.RDs"))

saveRDS(metadata, file = paste0(path, "/GSE_data/gse_all_meta_data.RDs"))
