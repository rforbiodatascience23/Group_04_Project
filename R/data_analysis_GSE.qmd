...
```{r}
exp_gse_results <- readRDS("/Users/mathildebechgaard/group_04_project/data/datagse_expressed_data.RDs")
mirna_exp <- readRDS("/Users/mathildebechgaard/group_04_project/data/datagse_all_data.RDs")
```
...
gse_vol <- ggplot(data = gse_results, aes(x = logFC,
  ...
  scale_color_manual(values = c("UP" = "red", 
                     ...
                     labels = c("UP" = "Upregulated", "DOWN" = "Downregulated", "NO" = "Non-significant")) +
...
# Define the path to the directory
path <- "/Users/mathildebechgaard/group_04_project/results/images"

ggsave(file.path(path, "gse_vol_plot.png"), plot = gse_vol, width = 14, height = 8.4, units = "in")
```
